...
pub const CUSTOM_APPLICATIVE_LOAD_INPUTS: &str = "load_custom_applicative_bootloader_inputs()";
pub const CUSTOM_APPLICATIVE_PREPARE_VERIFIERS: &str = "prepare_verifiers()";
pub const CUSTOM_APPLICATIVE_DEFAULT_AGGREGATOR_PREPARE: &str = "prepare_default_aggregator()";
