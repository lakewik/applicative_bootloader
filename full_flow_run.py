...
def main():
    ...
    print ("Preparing inputs for applicative bootloader execution...")
    with open(
        ...
        print ("Running the applicative bootloader with children nodes proofs and aggregator children nodes inputs...")
        with tempfile.TemporaryDirectory() as tmpdir:
            cairo_run(
                tmpdir=tmpdir,
                layout=LAYOUT,
